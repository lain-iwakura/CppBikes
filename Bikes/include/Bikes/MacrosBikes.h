...
#define MBIKES_NOTHING 

#define MBIKES_VARLIST1(V1) V1
#define MBIKES_VARLIST2(V1,V2) V1 MBIKES_COMMA V2
#define MBIKES_VARLIST3(V1,V2,V3) MBIKES_VARLIST2(V1,V2) MBIKES_COMMA V3
#define MBIKES_VARLIST4(V1,V2,V3,V4) MBIKES_VARLIST3(V1,V2,V3) MBIKES_COMMA V4
#define MBIKES_VARLIST5(V1,V2,V3,V4,V5) MBIKES_VARLIST3(V1,V2,V3,V4) MBIKES_COMMA V5
#define MBIKES_VARLIST6(V1,V2,V3,V4,V5,V6) MBIKES_VARLIST3(V1,V2,V3,V4,V5) MBIKES_COMMA V6
#define MBIKES_VARLIST7(V1,V2,V3,V4,V5,V6,V7) MBIKES_VARLIST3(V1,V2,V3,V4,V5,V6) MBIKES_COMMA V7
#define MBIKES_VARLIST8(V1,V2,V3,V4,V5,V6,V7,V8) MBIKES_VARLIST3(V1,V2,V3,V4,V5,V6,V7) MBIKES_COMMA V8
#define MBIKES_VARLIST9(V1,V2,V3,V4,V5,V6,V7,V8,V9) MBIKES_VARLIST3(V1,V2,V3,V4,V5,V6,V7,V8) MBIKES_COMMA V9
