#ifndef _CPPBIKES_MACROSBIKES_H_
#define _CPPBIKES_MACROSBIKES_H_
...
#define MACROSBIKES_TP1 T1 par1
#define MACROSBIKES_TP2 T1 par1, T2 par2
#define MACROSBIKES_TP3 T1 par1, T2 par2, T3 par3
#define MACROSBIKES_TP4 T1 par1, T2 par2, T3 par3, T4 par4
#define MACROSBIKES_TP5 T1 par1, T2 par2, T3 par3, T4 par4, T5 par5
#define MACROSBIKES_TP6 T1 par1, T2 par2, T3 par3, T4 par4, T5 par5, T6 par6
#define MACROSBIKES_TP7 T1 par1, T2 par2, T3 par3, T4 par4, T5 par5, T6 par6, T7 par7
#define MACROSBIKES_TP8 T1 par1, T2 par2, T3 par3, T4 par4, T5 par5, T6 par6, T7 par7, T8 par8
#define MACROSBIKES_TP9 T1 par1, T2 par2, T3 par3, T4 par4, T5 par5, T6 par6, T7 par7, T8 par8, T9 par9
